  ...
  data: () => {
    return {
      ...
      products: [
        {
          id: 1,
          name: { br: "Cyberleather Chrome", en: "Cyberleather Concrete" },
          ...
          photos: ["/pexels-cottonbro-4904537-", "/pexels-cottonbro-4904563-"],
        },
        {
          id: 2,
          ...
          photos: ["/pexels-cottonbro-4904563-"],
        },
        {
          id: 3,
          name: {
          ...
          photos: ["/pexels-cottonbro-8717527-"],
        },
        {
          id: 4,
          ...
          photos: ["/pexels-cottonbro-10679206-"],
        },
        {
          id: 5,
          ...
          photos: ["/pexels-cottonbro-5120193-"],
        },
      ],
    };
  },
